...
export interface ColAirInvoicePreviewProps {
...
export const ColAirInvoicePreview = memo(function ColAirInvoicePreview({
  row,
  exchangeRate,
  onClose = () => {},
  onConfirmSend,
  ...
  const invoiceNumber =
    propInvoiceNumber || `PREV-${row.warehouseId || "####"}`;
    ...
    if (packages.length > 0) {
      itemsHtml = packages
        ...
        <tr>
          <td style="padding:12px;border-bottom:1px solid #e2e8f0;vertical-align:top;">
            <div style="font-weight:600;color:#0f172a;margin-bottom:2px;">Servicio Aéreo Colombia</div>
      ...
      itemsHtml = `
        <tr>
          <td style="padding:12px;border-bottom:1px solid #e2e8f0;vertical-align:top;">
            <div style="font-weight:600;color:#0f172a;margin-bottom:2px;">Servicio Aéreo Colombia</div>
            <div style="color:#64748b;font-size:9px;">Trk: ${escHtml(row.warehouseId)} / Peso: ${row.peso} KG | Permisos: ${row.permisos ? "Sí" : "No"}</div>
          </td>
          <td style="padding:12px;border-bottom:1px solid #e2e8f0;text-align:center;font-size:10px;">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-slate-800">
                {t(
                  "spreadsheet.colAirPreviewTitle",
                  "Vista Previa - Aéreo Colombia",
                )}
              </h2>
        ...
        {onConfirmSend && (
          <div className="px-5 py-3 border-b border-border bg-slate-50 flex items-center justify-between gap-4">
            <Label className="text-xs text-muted-foreground">
              {t("spreadsheet.testEmailLabel", "Prueba de correo electrónico:")}
            </Label>
            ...
            >
                    ...
                    {packages.length > 0 ? (
                      ...
                      <tr>
                        ...
                        >
                          ...
                          >
                            Trk: {row.warehouseId} / Peso: {row.peso} KG |
                            Permisos: {row.permisos ? "Sí" : "No"}
                          </div>
                        </td>
                        <td
                          style={{
              ...
              <div style={{ padding: "0 16px 14px" }}>
                ...
                >
                  ...
                  >
                    • En caso de consolidación se otorgan dos semanas o bien 10
                    paquetes máximo, acorde a los términos y condiciones de la
                    página.
                    <br />
                    • En Caso de no ser recibido el paquete en ruta podria devengar costos de bodegaje ver terminos y condiciones.
                    <br />
                    • En caso de encomienda, los envíos se realizan con el corte
                    de las 4PM del día en que se envía la factura; posterior a
                    eso, todo lo que se cancela se asigna a la próxima ruta
                    hábil.
              ...
              <div style={{ padding: "0 16px 14px" }}>
                ...
                >
                  <div
                    style={{ fontSize: 11, color: "#991b1b", lineHeight: 1.5 }}
                  >
                    <strong>ℹ️ Comparta su comprobante:</strong> Es importante
                    que comparta su comprobante de pago para confirmación ya sea
                    en el WhatsApp de ruta de entrega o el WhatsApp de
              ...
              >
                ...
                >
                  SmartLogistics Premium Courier Service | Miami, FL | San José,
                  Costa Rica
                </div>
                <div
