...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ref={ref}
    className={cn(
      "absolute left-0 top-full mt-1.5 min-w-max rounded-md border bg-popover text-popover-foreground shadow-lg",
...
>(({ className, ...props }, ref) => (
  <div className="absolute left-0 top-full flex w-full justify-start">
    <div
      style={{
        transform:
          "translateX(var(--radix-navigation-menu-viewport-left, 0px))",
      }}
    >
