...
export declare const COLLECTIONS: {
    ...
    readonly AUDIT: "audit_logs";
    readonly SCANNER_HISTORY: "scannerHistory";
    readonly QUOTES: "quotes";
    readonly MANIFESTS: "manifests";
    readonly DEPARTMENTS: "departments";
    readonly EMPLOYEES: "employees";
};
export declare const SUBCOLLECTIONS: {
    readonly PROFILE: "profile";
    readonly TRACKING_HISTORY: "trackingHistory";
    readonly ITEMS: "items";
    readonly ROUTE_PACKAGES: "packages";
};
